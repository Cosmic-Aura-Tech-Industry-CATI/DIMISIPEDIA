...
export const journeyTranslations: Record<"hinglish" | "hi", Record<string, PhaseTranslation>> = {
  ...
  hi: {
    ...
    "phase-4": {
      title: "“Chalo Kalesh Karey” और कोर दल का गठन",
      subtitle: "Kalesh नामकरण, लैब परिचर्चा एवं शीलू सिंह तथा मृदुल मिश्रा का आगमन।",
      quoteText:
        "अनाम एवं निष्पक्ष संवाद में स्वाभाविक रूप से विचार-विमर्श होता है, अतः 'Kalesh' सर्वथा उपयुक्त नाम है।",
      narrative: [
        "लैब में प्रोटोटाइप देखने के उपरांत स्वतंत्र उत्साहित हुए, जबकि निष्कर्ष ने तकनीकी एवं व्यावहारिक पक्षों पर प्रश्न किए। प्रिया द्वारा 'Kalesh' नाम प्रस्तावित किया गया जिसे स्वतंत्र ने 'Chalo Kalesh Karey' के उद्घोष के साथ स्वीकारा।",
        "शीलू सिंह को मोबाइल लीड (फ़्लटर) और मृदुल मिश्रा को बैकएंड एवं लिनक्स लीड के रूप में दल में सम्मिलित किया गया।",
      ],
      highlights: [
        "'Kalesh' नामकरण और 'Chalo Kalesh Karey' का नारा",
    ...
    "phase-7": {
      title: "परीक्षा कक्ष सूत्र और DIMISI का प्रादुर्भाव",
      subtitle: "उत्तर-पुस्तिका के पीछे 'DI + MI + SI' सूत्र की रचना और कंपनी का निगमन।",
      quoteText: "दीक्षित का DI, मिश्रा का MI, सिंह का SI — मिलकर बना DIMISI।",
      narrative: [
        "एमसीए पोर्टल पर CATI नाम उपलब्ध न होने पर परीक्षा कक्ष में शिखर ने अपने सह-संस्थापकों के उपनामों से सूत्र गढ़ा: DI (Dixit) + MI (Mishra) + SI (Singh) = DIMISI। 9 अप्रैल 2026 को DIMISI Technologies Private Limited विधिवत निगमित हुई (CIN: U62013UP2026PTC246506)।",
      ],
      highlights: [
    ...
    "phase-10": {
      title: "DIMISIPEDIA और भावी क्षितिज",
      ...
      narrative: [
        "19 अगस्त 2026 को DIMISIPEDIA का निर्माण आरंभ हुआ ताकि समस्त तकनीकी एवं संगठनात्मक इतिहास पारदर्शी एवं सत्यापित रूप में उपलब्ध रहे। सह-संस्थापकों, परिजनों और जीवनसाथी प्रिया के प्रति कृतज्ञता के साथ यह यात्रा निरंतर अग्रसर है।",
      ],
      highlights: [
        "19 अगस्त 2026 को DIMISIPEDIA का प्रादुर्भाव",
