...
export const article: Article = {
  ...
  category: "Projects",
  tags: ["Kalesh", "Social Media", "Anonymous Polling", "DIMISI Technologies", "Flutter", "Node.js", "MongoDB"],
  ...
  content: [
    ...
    { type: "entity", entityId: "kalesh", note: "The software application detailed in this article." },
    { type: "entity", entityId: "dimisi-technologies", note: "The engineering organization developing Kalesh." },
    { type: "entity", entityId: "shikhar-dixit", note: "The creator and product architect of Kalesh." },
  ],
  sourceIds: ["src-kalesh-app", "src-dimisi-tech-web"],
  relatedEntities: ["kalesh", "dimisi-technologies", "shikhar-dixit", "flutter", "node-js", "mongodb"],
