...
export function KnowledgeGraphVisualizer() {
  ...
  const [activeFilter, setActiveFilter] = useState<"all" | "person" | "project" | "technology">(
    "all",
  );
                ...
                return (
                  ...
                  >
                    ...
                    <circle
                      ...
                      stroke={
                        isSelected ? "hsl(var(--primary))" : isConnected ? "#4b5563" : "#1f2937"
                      }
        ...
        <div className="border-t lg:border-t-0 lg:border-l border-rule bg-surface p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="label-mono text-[11px]">{connectedLinks.length} Connections</span>
            </div>
